...
const Dashboard = () => {
    ...
    return (
        (bookingdata.loading || usersdata.loading) 
            ? <CircularLoading/> 
            :
        <div>
            ...
            <Paper style={{marginTop:'25px'}}>
                ...
                <Map mapcenter={mylocation} locations={locations}
                    googleMapURL="https://maps.googleapis.com/maps/api/js?key=AIzaSyC0xyQOvHWcnnrpGO1pe7Ty2O9O6tueFEQ&v=3.exp&libraries=geometry,drawing,places"
                    loadingElement={<div style={{ height: `480px` }} />}
                    containerElement={<div style={{ height: `480px` }} />}
                    mapElement={<div style={{ height: `480px` }} />}
                />
            </Paper> : <Typography variant="h4" style={{margin:"20px 0 0 15px",color:'#FF0000'}}>{languageJson.allow_location}</Typography>
            }
        </div>
